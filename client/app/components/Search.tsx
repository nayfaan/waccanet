  ...
  return (
    <form onSubmit={getSearch}>
      <div className="relative w-full my-3">
        ...
        <button
          type="submit"
          className="absolute p-2 end-2 bottom-1.5 rounded-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 cursor-pointer"
        >
          <BiSearch size={18} />
        </button>
      </div>

...
export default async function Home({
  ...
  const paginationPropertiesData: PaginationProperties = await fetchPropertyListSearchPagination(search_query, page);
  ...
  return (
    <>
      <main>
        ...
        <div className="fixed z-50 w-full bg-white shadow-md p-1 sm:px-6">
